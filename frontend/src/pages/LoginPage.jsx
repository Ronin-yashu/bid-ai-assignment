...
export default function LoginPage() {
  ...
  const handleSubmit = e => {
    e.preventDefault()
    alert('Login functionality — connect to your auth backend!')
  }
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-xl">
          ...
          <p className="text-center text-sm text-gray-500 mt-4">
            Don't have an account? <Link to="/signup" className="text-[#FF6B2B] font-semibold hover:underline">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
